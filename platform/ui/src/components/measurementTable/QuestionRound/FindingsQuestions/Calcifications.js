...
const Calcifications = ({ handleChange, values }) => {
  ...
  return (
    <div className={style.button}>
      ...
      <div
        ...
        value={values.calcifications_details.typically_benign}
        onChange={handleChange('calcifications_details')}
      >
      ...
      <div
        className="radio-toolbar density"
        value={values.calcifications_details.suspicious}
        onChange={handleChange('calcifications_details')}
      >
